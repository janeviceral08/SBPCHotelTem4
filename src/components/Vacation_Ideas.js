...
handleImageUpload  = () =>{
  ...
  axios.post('http://localhost:5000/about_hotel/Add_About_hotel', exercise)
  .then(res =>{
      if(res.data == 'Added!'){
    ...
    .then(res => {
     ...
     const exercise = { 
      ...
      img1: res.secure_url,
        ...
        axios.post('http://localhost:5000/about_hotel/image1_edit', exercise)
          .then(res =>{
            if(res.data === 'updated!'){
              window.location.reload()
            }else{
    ...
    .then(res => {
     ...
     const exercise = { 
      ...
      img2: res.secure_url,
        ...
        axios.post('http://localhost:5000/about_hotel/image2_edit', exercise)
          .then(res =>{
            if(res.data === 'updated!'){
              window.location.reload()
            }else{
...
onDelete = (id,title) => {
    ...
    confirmAlert({
        ...
        buttons: [
          {
            label: 'Yes',
            onClick: () =>(cogoToast.success('Please wait a moment...'),  axios.post('http://localhost:5000/about_hotel/About_hotel_Delete', exercise)
            .then(res =>{
...
<label for="file">Subtitle:</label> <br />
          <TextField id="outlined-basic" label="Subtitle" variant="outlined" onChange={this.onChangesubtitle} />
<br />
