...
if(files[0] != undefined){
  ...
  .then(res => {
    ...
    const exercise = {
      ...
      axios.post('http://localhost:5000/hotel_offer/Add_Hotel_Offer', exercise)
      .then(res =>{
...
onDelete = (id,title) => {
    ...
    confirmAlert({
        ...
        buttons: [
          {
            label: 'Yes',
            onClick: () =>(cogoToast.success('Please wait a moment...'),  axios.post('http://localhost:5000/hotel_offer/Hotel_Offer_Delete', exercise)
            .then(res =>{
