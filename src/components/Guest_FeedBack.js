  ...
  onDelete = (id,title) => {
    ...
    confirmAlert({
        ...
        buttons: [
          {
            label: 'Yes',
            onClick: () =>  axios.post('http://localhost:5000/feedback/delete_Feedback', exercise)
            .then(res =>{
    ...
    return (
     ...
     <li onClick={()=> this.getInfoID(info.partition, info.expiration)} key={i} className="treeview active">
      ...
      <div class="form-group">
          ...
          <TextField id="outlined-basic" label="Name of Guest" variant="outlined"  onChange={this.onChangename}/>
          <br />
